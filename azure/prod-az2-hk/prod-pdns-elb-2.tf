module "prod-pdns-elb-2" {
  source = "../modules/app"

  resource_group_name = local.resource_group_name

  load_balancer = {
    name                    = "prod-pdns-elb-2"
    frontend_config_name    = "prod-pdns-elb-frontend-2"
    frontend_public_ip_name = "prod-pdns-elb-frontend-2-ip"
    backend_pool_name       = "prod-pdns-elb-2"
  }

  vmss = {
    name            = "prod-pdns-vmss-2"
    hostname_prefix = "prod-az2-hk-pdns2"
    instance_count  = 0
    capacity = {
      min = 0
      max = 16
